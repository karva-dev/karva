...
mod tests {
    ...
    fn relative_path_is_joined_to_cwd() {
        assert_snapshot!(absolute("foo/bar", "/home/user"), @"/home/user/foo/bar");
    }

    #[test]
    fn absolute_path_ignores_cwd() {
        assert_snapshot!(absolute("/absolute/path", "/home/user"), @"/absolute/path");
    }

    #[test]
    fn parent_dir_pops_component() {
        assert_snapshot!(absolute("../sibling", "/home/user"), @"/home/sibling");
    }

    #[test]
    fn current_dir_is_ignored() {
        assert_snapshot!(absolute("./foo", "/home/user"), @"/home/user/foo");
    }

    #[test]
    fn mixed_components() {
        assert_snapshot!(absolute("foo/../bar/./baz", "/cwd"), @"/cwd/bar/baz");
    }

    #[test]
    fn empty_relative_path_returns_cwd() {
        assert_snapshot!(absolute("", "/home/user"), @"/home/user");
    }

    #[test]
    fn leading_parent_pops_cwd() {
        assert_snapshot!(absolute("../../other", "/home/user"), @"/other");
    }
    ...
    fn parent_past_root_stays_at_root() {
        assert_snapshot!(absolute("../..", "/"), @"/");
    }

    #[test]
    fn unicode_path_components_are_preserved() {
        assert_snapshot!(absolute("カルヴァ/tests", "/home/ユーザー"), @"/home/ユーザー/カルヴァ/tests");
    }

    #[test]
    fn path_with_spaces_is_preserved() {
        assert_snapshot!(absolute("my tests/file.py", "/home/my user"), @"/home/my user/my tests/file.py");
    }
    ...
    fn trailing_slash_on_relative_input_is_normalized() {
        ...
        assert_snapshot!(with, @"/cwd/foo/bar");
    }
